  ...
  return (
    <section className="bg-white space-y-16 pb-16 ">
      ...
      <div className="flex flex-col justify-center items-center space-y-8">
        <div><span className="text-3xl md:text-6xl text- font-bold">"</span></div>
        <div className="">
            <h2 className="text-2xl md:text-4xl text-[#004474] text-center max-w-sm md:max-w-4xl font-medium leading-normal md:leading-relaxed">"This HR solution has transformed our workforce management. The intuitive features, real-time analytics, and seamless integration have greatly improved productivity and employee satisfaction."</h2>
        </div>
        <div className="flex flex-col items-center justify-center  space-y-1">
        <div className="w-12 h-12 rounded-full">
        <Image src={testImag} width={20} height={20} className="object-cover w-full h-full rounded-full" />
        </div>
